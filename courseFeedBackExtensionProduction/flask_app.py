...
def calculate_course_rating(cursor, dept, course_id):
    ...
    if valid_result_count == 0:
        return None
    average_rating = sum(total_ratings[col] for col in course_rating_columns) / (valid_result_count * len(course_rating_columns))
...
def get_course_feedback():
    ...
    try:
        ...
        for course in data:
            ...
            # If course_rating is None, try with alternative listings
